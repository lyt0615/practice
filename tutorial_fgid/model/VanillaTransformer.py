...
from model.modules import clones, LayerNorm, EncoderLayer, MultiHeadedAttention, PositionwiseFeedForward, LearnablePositionalEncoding, LearnableClassEmbedding
from model.base import register_model
import torch
...
if __name__ == "__main__":
    ...
    model = VanillaTransformerEncoder(**params, nlayer=6)
    y = model(x)
    print(y.shape)
    print(model)
